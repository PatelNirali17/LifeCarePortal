...
import { AmbulanceCallListComponent } from "./ambulance-call-list/page/ambulance-call-list/ambulance-call-list.component";
...
export const AmbulanceRoutesList: Routes = [
    ...
    { path: 'ambulancecalllist', component: AmbulanceCallListComponent, data: { breadcrumb: 'Ambulance Call List' } },
]